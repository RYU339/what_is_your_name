...
# image upload
from cup.predict import predict_image
from cup.visionAPI import detect_text


def img_upload(request):
    return render(request, 'cup/img_upload.html', {})
...
def pred_img(request):
    ...
    return render(request, 'cup/result.html', context)
...
def detect_img_text(request, file_name):
    ...
    return render(request, 'cup/text_reader.html', context)
